<div id="footer" class="sixteen columns">
  <div class="three columns footer_left">
    <ul>
      <li>
        <a href="http://picandocodigo.net/about/">
          Acerca de
        </a>
      </li>
      <li>
        <a href="http://picandocodigo.net/about/licencia/">
          Licencia
        </a>
      </li>
      <li>
        <a href="http://picandocodigo.net/sitemap/">
          Mapa del sitio
        </a>
      </li>
      <li>
        <a href="http://picandocodigo.net/contacto/">
          Contacto
        </a>
      </li>
    </ul>
